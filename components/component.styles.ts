const styles = {
    ...
    */
    ...
    titleHead: `mb-2 text-2xl font-extrabold leading-none max-w-5xl mx-auto tracking-normal text-gray-900 sm:text-xl md:text-xl lg:text-7xl md:tracking-tight`,
